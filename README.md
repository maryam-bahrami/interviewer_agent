...
Prompt the candidate with the first question.
Evaluate the answer, optionally ask follow‑up questions, and move to the next question.
After all questions are answered, generate a review and a Markdown report (report.md) in the working directory.
Output
